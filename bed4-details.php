...
?>
    ...
    <div class="product-section">
        <div class="image-gallery">
            <img src="./Images/sofa-imgs/bed4.1.webp" alt="Product Image" class="main-image" id="mainImage">
            <div class="thumbnail-container">
                <img src="./Images/sofa-imgs/bed4.2.webp" alt="" class="thumbnail" onclick="changeImage(this)">
                <img src="./Images/sofa-imgs/bed4.3.webp" alt="" class="thumbnail" onclick="changeImage(this)">
                <img src="./Images/sofa-imgs/bed4.4.webp" alt="" class="thumbnail" onclick="changeImage(this)">
                <img src="./Images/sofa-imgs/bed4.5.webp"" class="thumbnail" onclick="changeImage(this)">
                <!-- <img src="./Images/sofa-imgs/bed4.6.webp" alt="" class="thumbnail" onclick="changeImage(this)"> -->
               

            </div>
        </div>
        <div class="product-details">
            <h1 class="product-title">Burbage Upholstered Bed</h1>
            <p class="product-price">Rs. 80,373.50 <span style="text-decoration: line-through; color: #999;">Rs 87,299</span></p>
            <p class="product-description">Super luxurious bed, upholstered to perfection. Will change the look of your bedroom. The tufted headboard will make any room decor come alive.</p>
            ...
            <div class="button-container">
                <button
                onclick="addToCart('Burbage Upholstered Bed', 'Rs. 80,373.00', './Images/sofa-imgs/bed4.1.webp')"
