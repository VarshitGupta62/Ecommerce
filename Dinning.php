            ...
            <div class="container py-5">
                <div class="row g-4 justify-content-center">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="#">
                            <div class="service-item bg-primary rounded border border-primary">
                                <img style="height: 350px;" src="Images/sofa-imgs/LuisPierreDiningSet1.webp" class="img-fluid rounded-top w-100 hover1" alt="">
                                ...
                                <div class="px-4 rounded-bottom">
                                    ...
                                    <h6>Luis Pierre DiningSet <br>
                                       <b>Rs. 14,375.00</b>   <Del>Rs. 10.350</Del>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="#">
                            <div class="service-item bg-primary rounded border border-primary">
                                <img style="height: 350px;" src="Images/sofa-imgs/AmorPierreDiningSet2.webp" class="img-fluid rounded-top w-100" alt="">
                                <div class="px-4 rounded-bottom">
                                    <div class="service-content bg-secondary text-center p-4 rounded">
                                        <h5 class="text-white"> </h5>
                                        <h3 class="mb-0">Save Up To 51% off</h3>
                                    </div>
                                    <h6>Amor Pierre Dining Set<br>
                                        <b>Rs. 14,375.00</b>   <Del>Rs. 21,275.00</Del>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="#">
                            <div class="service-item bg-primary rounded border border-primary">
                                <img style="height: 350px;" src="Images/sofa-imgs/Alba_Pierre_Dining_Set3.webp" class="img-fluid rounded-top w-100" alt="">
                                <div class="px-4 rounded-bottom">
                                    <div class="service-content bg-secondary text-center p-4 rounded">
                                        <h5 class="text-white"> </h5>
                                         <h3 class="mb-0">Save Up To 25% off</h3> 
                                    </div>
                                    <h6>Alba Pierre Dining Set <br>
                                        <b>Rs. 11,747.25 </b>    
                                        <del>Rs. 19,550.00</del>
                                       </h6>
                                </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="#">
                            <div class="service-item bg-primary rounded border border-primary">
                                <img style="height: 350px;" src="Images/sofa-imgs/AlbaMUlloyDiningSet5.webp" class="img-fluid rounded-top w-100" alt="">
                                <div class="px-4 rounded-bottom">
                                    <div class="service-content bg-secondary text-center p-4 rounded">
                                        <h5 class="text-white"> </h5>
                                        <h3 class="mb-0">Save Up To 38% off</h3>
                                    </div>
                                    <h6>Alba MUlloy Dining Set <br> <b>Rs. 13,800.00</b> <del>Rs. 20,125.00</del></h6>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="#">
                            <div class="service-item bg-primary rounded border border-primary">
                                <img style="height: 350px;" src="Images/sofa-imgs/LuisBobDiningSets6.webp" class="img-fluid rounded-top w-100" alt="">
                                <div class="px-4 rounded-bottom">
                                    <div class="service-content bg-secondary text-center p-4 rounded">
                                        <h5 class="text-white"> </h5>
                                        <h3 class="mb-0">Save Up To 23% off</h3>
                                    </div>
                                    <h6>Luis BobDining Sets <br> <b>Rs. 28,175.00</b> <del>Rs. 33,350.00</del></h6>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="#">
                            <div class="service-item bg-primary rounded border border-primary">
                                <img style="height: 350px;" src="Images/sofa-imgs/Alba_Jean_DIning_Set7.webp" class="img-fluid rounded-top w-100" alt="">
                                <div class="px-4 rounded-bottom">
                                    <div class="service-content bg-secondary text-center p-4 rounded">
                                        <h5 class="text-white"> </h5>
                                        <h3 class="mb-0">9% off</h3>
                                    </div>
                                    <h6>Alba Jean DIning Set <br> <b>Rs. 11,747.25 </b> <del>Rs. 19,550.00</del></h6>
