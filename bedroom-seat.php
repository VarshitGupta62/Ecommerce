            ...
            <div class="container py-5">
                <div class="row g-4 justify-content-center">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="bed-details.html">
                            <div class="service-item bg-primary rounded border border-primary">
                                <img style="height: 350px;" src="Images/sofa-imgs/bedroom sets1.webp" class="img-fluid rounded-top w-100 " alt="">
...
img.addEventListener('mouseleave', () => {
    img.src = './Images/sofa-imgs/2...sofas-accent-chairs-rose-gold-boucle-amor-2-seater-sofa.webp'
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="bed-details.html">
                            <div class="service-item bg-primary rounded border border-primary">
                                <img style="height: 350px;" src="Images/sofa-imgs/bedroom sets2.webp" class="img-fluid rounded-top w-100" alt="">
                                <div class="px-4 rounded-bottom">
                                    <div class="service-content bg-secondary text-center p-4 rounded">
                                        <h5 class="text-white"> </h5>
...
img1.addEventListener('mouseleave', () => {
    img1.src = 'Images/sofa-imgs/2.1sofa.webp';
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="bed-details.html">
                            <div class="service-item bg-primary rounded border border-primary">
                                <img style="height: 350px;" src="./Images/sofa-imgs/bedroom sets3.webp" class="img-fluid rounded-top w-100 " alt="">
                                <div class="px-4 rounded-bottom">
                                    <div class="service-content bg-secondary text-center p-4 rounded">
                                        <h5 class="text-white"> </h5>
                                         <!-- <h3 class="mb-0">Save Up To 25% off</h3>  -->
...
<!-- js -->
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="bed-details.html">
                            <div class="service-item bg-primary rounded border border-primary ">
                                <img style="height: 350px;" src="Images/sofa-imgs/bedroom sets4.webp" class="img-fluid rounded-top w-100" alt="">
                                <div class="px-4 rounded-bottom">
                                    <div class="service-content bg-secondary text-center p-4 rounded">
                                        <h5 class="text-white"> </h5>
                                        <!-- <h3 class="mb-0">Save Up To 25% off</h3> -->
                                    </div>
                                    <h6>Bedroom Seat<br><b>Rs. 10,373.50</b>
                                    </h6>
                                </div>
                            </div>
                        </a>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="bed-details.html">
                            <div class="service-item bg-primary rounded border border-primary">
                                <img style="height: 350px;" src="Images/sofa-imgs/bedroom sets5.webp" class="img-fluid rounded-top w-100" alt="">
                                <div class="px-4 rounded-bottom">
                                    <div class="service-content bg-secondary text-center p-4 rounded">
                                        <h5 class="text-white"> </h5>
                                        <!-- <h3 class="mb-0">Save Up To 23% off</h3> -->
                                    </div>
                                    <h6>Bedroom seat<br> <b>Rs. 5,773.00</b></h6>
                                </div>
                        ...
                        <a href="bed-details.html">
                            <div class="service-item bg-primary rounded border border-primary">
                                ...
                                <div class="px-4 rounded-bottom">
                                    ...
                                    <h6>Bedroom Seat<br> <b>Rs. 16,448.00</b> </h6>
