                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="nightstand-details.html">
                            <div class="service-item bg-primary rounded border border-primary">
                                <img style="height: 350px;" src="Images/sofa-imgs/home-office1.webp" class="img-fluid rounded-top w-100 " alt="">
...
img.addEventListener('mouseleave', () => {
    img.src = './Images/sofa-imgs/2...sofas-accent-chairs-rose-gold-boucle-amor-2-seater-sofa.webp'
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="nightstand-details.html">
                            <div class="service-item bg-primary rounded border border-primary">
                                <img style="height: 350px;" src="Images/sofa-imgs/home-office2.webp" class="img-fluid rounded-top w-100" alt="">
                                <div class="px-4 rounded-bottom">
                                    <div class="service-content bg-secondary text-center p-4 rounded">
                                        <h5 class="text-white"> </h5>
...
img1.addEventListener('mouseleave', () => {
    img1.src = 'Images/sofa-imgs/2.1sofa.webp';
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="nightstand-details.html">
                            <div class="service-item bg-primary rounded border border-primary">
                                <img style="height: 350px;" src="./Images/sofa-imgs/home-office3.webp" class="img-fluid rounded-top w-100 " alt="">
                                <div class="px-4 rounded-bottom">
                                    <div class="service-content bg-secondary text-center p-4 rounded">
                                        <h5 class="text-white"> </h5>
                                         <!-- <h3 class="mb-0">Save Up To 25% off</h3>  -->
                                    </div>
                                    <h6>Home-office<br><b>Rs. 96,082.50</b>    <del>Rs. 90,850.00</del>
                                    </h6>
                                </div>
...
<!-- js -->
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="nightstand-details.html">
                            <div class="service-item bg-primary rounded border border-primary ">
                                <img style="height: 350px;" src="Images/sofa-imgs/home-office4.webp" class="img-fluid rounded-top w-100" alt="">
                                <div class="px-4 rounded-bottom">
                                    <div class="service-content bg-secondary text-center p-4 rounded">
                                        <h5 class="text-white"> </h5>
                                        <!-- <h3 class="mb-0">Save Up To 25% off</h3> -->
                                    </div>
                                    <h6>HOme -office <br><b>Rs. 80,373.50</b>
                                    </h6>
                                </div>
                            </div>
                        </a>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="nightstand-details.html">
                            <div class="service-item bg-primary rounded border border-primary">
                                <img style="height: 350px;" src="Images/sofa-imgs/home-office5.webp" class="img-fluid rounded-top w-100" alt="">
                                <div class="px-4 rounded-bottom">
                                    <div class="service-content bg-secondary text-center p-4 rounded">
                                        <h5 class="text-white"> </h5>
                                        <!-- <h3 class="mb-0">Save Up To 23% off</h3> -->
                                    </div>
                                    <h6>Office<br> <b>Rs. 5,773.00</b></h6>
                                </div>
