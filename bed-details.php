...
?>
    ...
    <div class="product-section">
        <div class="image-gallery">
            <img src="./Images/sofa-imgs/bed1.webp" alt="Product Image" class="main-image" id="mainImage">
            <div class="thumbnail-container">
                ...
                <!-- <img src="./Images/sofa-imgs/bed1.6.webp" alt="" class="thumbnail" onclick="changeImage(this)">
                <img src="./Images/sofa-imgs/bed1.7.webp" alt="" class="thumbnail" onclick="changeImage(this)">
                <img src="./Images/sofa-imgs/bed1.8.webp" alt="" class="thumbnail" onclick="changeImage(this)"> -->

            </div>
        </div>
        <div class="product-details ">
            <h1 class="product-title">Sven Upholstered Bed</h1>
            <p class="product-price">Rs 73,025.00 <span style="text-decoration: line-through; color: #999;">Rs 87,299</span></p>
            <p class="product-description">Spartan but luxurious, thats understated style and comfort for you. Superbly built and finished to perfection, this will the bedroom of your dreams.</p>
            <div class="product-overview">
                <h3>Note:</h3>
               <p>NOTE: All dimensions given are for King Size Bed. The Queen Size bed dimensions will scale down as per mattress size.</p>
            </div>

            <div class="button-container">
                <button
                onclick="addToCart('Sven Upholstered Bed', 'Rs. 73,025.00', './Images/sofa-imgs/bed1.webp')"
