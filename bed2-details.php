...
?>
    ...
    <div class="product-section">
        <div class="image-gallery">
            <img src="./Images/sofa-imgs/bed2.webp" alt="Product Image" class="main-image" id="mainImage">
            <div class="thumbnail-container">
                <img src="./Images/sofa-imgs/bed1.2.webp" alt="" class="thumbnail" onclick="changeImage(this)">
                <img src="./Images/sofa-imgs/bed1.3.webp" alt="" class="thumbnail" onclick="changeImage(this)">
                <img src="./Images/sofa-imgs/bed1.4.webp" alt="" class="thumbnail" onclick="changeImage(this)">
                <img src="./Images/sofa-imgs/bed1.5.webp" alt="" class="thumbnail" onclick="changeImage(this)">
        ...
        <div class="product-details">
            ...
            <p class="product-price">Rs. 74,865.00 <span style="text-decoration: line-through; color: #999;">Rs 87,299</span></p>
