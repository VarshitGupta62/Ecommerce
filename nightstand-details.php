...
<!-- Navbar End -->
    ...
    <div class="product-section">
        <div class="image-gallery">
            <img src="./Images/sofa-imgs/nightstand1.webp" alt="Product Image" class="main-image" id="mainImage">
            <div class="thumbnail-container">
                <img src="./Images/sofa-imgs/Nightstand2.webp" alt="" class="thumbnail" onclick="changeImage(this)">
                <img src="./Images/sofa-imgs/nightstand3.webp" alt="" class="thumbnail" onclick="changeImage(this)">
                <img src="./Images/sofa-imgs/nightstand4.webp" alt="" class="thumbnail" onclick="changeImage(this)">
                <!-- <img src="./Images/sofa-imgs/nightstand5.webp" alt="" class="thumbnail" onclick="changeImage(this)">
                <img src="./Images/sofa-imgs/nightstand3.webp" alt="" class="thumbnail" onclick="changeImage(this)"> -->
        ...
        <div class="product-details">
            <h1 class="product-title">Cali Low Night Stand</h1>
            <p class="product-price">Rs. 14,375.00 <span style="text-decoration: line-through; color: #999;">Rs 87,299</span></p>
            <p class="product-description">Natural mango frame in black Duco, for a light, textural look with fresh organic allure. One Drawer at the bottom and storage area above.

                Natural Rattan Cane work on top. Glass is provided on top for practical everyday use.</p>
            ...
            <div class="button-container">
                <button
                onclick="addToCart('Althea Upholstered Hydraulic Storage Bed', 'Rs. 14,865.00', './Images/sofa-imgs/nightstand1.webp')"
