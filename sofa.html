            ...
            <div class="container py-5">
                <div class="row g-4 justify-content-center">
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <a href="sofa-details.html">
                            <div class="service-item bg-primary rounded border border-primary">
                                <img style="height: 350px;" src="Images/sofa-imgs/2...sofas-accent-chairs-rose-gold-boucle-amor-2-seater-sofa.webp" class="img-fluid rounded-top w-100 hover1" alt="">

                                <div class="px-4 rounded-bottom">
                                    <div class="service-content bg-secondary text-center  rounded">
                                        <h5 class="text-white"> </h5>
                                        <h3 class="mb-0">Save Up To 30% off</h3>
                                    </div>
                                    <h6>Amor 2 Seater Sofa - 71 <br>
                                       <b>Rs. 51,750</b>   <Del>Rs.74,750</Del>
                     ...
                     <script>
                        const img = document.querySelector('.hover1');

img.addEventListener('mouseenter', () => {
    img.src = './Images/sofa-imgs/4....sofas-accent-chairs-rose-gold-boucle-amor-2-seater-sofa-4.webp';

});

img.addEventListener('mouseleave', () => {
    img.src = './Images/sofa-imgs/2...sofas-accent-chairs-rose-gold-boucle-amor-2-seater-sofa.webp'
});
                    </script> 
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="sofa-details.html">
                            <div class="service-item bg-primary rounded border border-primary">
                                <img style="height: 350px;" src="Images/sofa-imgs/2.1sofa.webp" class="img-fluid rounded-top w-100 hover_2" alt="">
                                <div class="px-4 rounded-bottom">
                                    <div class="service-content bg-secondary text-center  rounded">
                                        <h5 class="text-white"> </h5>
                                        <h3 class="mb-0">Save Up To 25% off</h3>
                                    </div>
                                    <h6>Sven Large 2 Seater Sofa - 72 <br>
                                        <b>Rs. 51,175.00</b>   <Del>Rs.68,425</Del>
                    ...
                    <script>
                        const img1 = document.querySelector('.hover_2');

img1.addEventListener('mouseenter', () => {

    img1.src = 'Images/sofa-imgs/2.2sofa.webp';

});

img1.addEventListener('mouseleave', () => {
    img1.src = 'Images/sofa-imgs/2.1sofa.webp';
});
                    </script>
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <a href="sofa-details.html">
                            <div class="service-item bg-primary rounded border border-primary">
                                <img style="height: 350px;" src="./Images/sofa-imgs/3Derek_4.webp" class="img-fluid rounded-top w-100 hover_3" alt="">
                                <div class="px-4 rounded-bottom">
                                    <div class="service-content bg-secondary text-center p-4 rounded">
                                        <h5 class="text-white"> </h5>
                                         <h3 class="mb-0">Save Up To 25% off</h3> 
                                    </div>
                                    <h6>Derek 4 Seater Sofa - 92 <br><b>Rs. 66,688.50</b>    <del>Rs. 90,850.00</del>
                                    </h6>
                                </div>
                    ...
                    <!-- js -->
                    <script>
                        const img3 = document.querySelector('.hover_3');

img3.addEventListener('mouseenter', () => {
    
    img3.src = './Images/sofa-imgs/3.2Derek_4.webp';

});

img3.addEventListener('mouseleave', () => {
    img3.src = './Images/sofa-imgs/3Derek_4.webp';
});
                    </script>
...
<!-- js -->
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <a href="sofa-details.html">
                            <div class="service-item bg-primary rounded border border-primary ">
                                <img style="height: 350px;" src="Images/sofa-imgs/3Derek_4.webp" class="img-fluid rounded-top w-100" alt="">
                                <div class="px-4 rounded-bottom">
                                    <div class="service-content bg-secondary text-center  rounded">
                                        <h5 class="text-white"> </h5>
                                        <h3 class="mb-0">Save Up To 25% off</h3>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="sofa-details.html">
                            <div class="service-item bg-primary rounded border border-primary">
                                <img style="height: 350px;" src="Images/sofa-imgs/5sofa.webp" class="img-fluid rounded-top w-100" alt="">
                                <div class="px-4 rounded-bottom">
                                    <div class="service-content bg-secondary text-center  rounded">
                                        <h5 class="text-white"> </h5>
                                        <h3 class="mb-0">Save Up To 23% off</h3>
                                    </div>
                                    <h6>Alexis 3 Seater Sofa - 84 <br> <b>Rs. 75,210.00</b> <del> Rs. 97,980.00</del></h6>
                                </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="sofa-details.html">
                            <div class="service-item bg-primary rounded border border-primary">
                                <img style="height: 350px;" src="Images/sofa-imgs/8..sofas-accent-chairs-rose-gold-boucle-amor-2-seater-sofa-8.webp" class="img-fluid rounded-top w-100" alt="">
                                <div class="px-4 rounded-bottom">
                                    <div class="service-content bg-secondary text-center rounded">
                                        <h5 class="text-white"> </h5>
                                        <h3 class="mb-0">10% off</h3>
                                    </div>
                                    <h6>Alba 2 Seater Sofa - 72 <br> <b>Rs. 51,336.00</b> <del>Rs. 62,617.50</del></h6>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="sofa-details.html">
                            <div class="service-item bg-primary rounded border border-primary">
                                <img style="height: 350px;" src="Images/sofa-imgs/4sofa.webp" class="img-fluid rounded-top w-100" alt="">
                                <div class="px-4 rounded-bottom">
                                    <div class="service-content bg-secondary text-center  rounded">
                                        <h5 class="text-white"> </h5>
                                        <h3 class="mb-0">Save Up To 47% off</h3>
                                    </div>
                                    <h6>Derek L Shape Sofa <br> <b>Rs. 78,154.00</b> <del>Rs. 148,865.20</del></h6>
                                </div>
                            </div>
                        </a>
                    </div>
