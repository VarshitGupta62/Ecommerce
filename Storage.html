            ...
            <div class="container py-5">
                <div class="row g-4 justify-content-center">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="nightstand-details.html">
                            <div class="service-item bg-primary rounded border border-primary">
                                <img style="height: 350px;" src="Images/sofa-imgs/nightstand1.webp" class="img-fluid rounded-top w-100 " alt="">
...
img.addEventListener('mouseleave', () => {
    img.src = './Images/sofa-imgs/2...sofas-accent-chairs-rose-gold-boucle-amor-2-seater-sofa.webp'
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="nightstand-details.html">
                            <div class="service-item bg-primary rounded border border-primary">
                                <img style="height: 350px;" src="Images/sofa-imgs/Nightstand2.webp" class="img-fluid rounded-top w-100" alt="">
                                <div class="px-4 rounded-bottom">
                                    <div class="service-content bg-secondary text-center p-4 rounded">
                                        <h5 class="text-white"> </h5>
                                        <!-- <h3 class="mb-0">Save Up To 25% off</h3> -->
                                    </div>
                                    <h6>Chantel Rattan Mango Natural Bedside Table<br>
                                        <b>Rs. 16,675.00</b>
...
img1.addEventListener('mouseleave', () => {
    img1.src = 'Images/sofa-imgs/2.1sofa.webp';
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="nightstand-details.html">
                            <div class="service-item bg-primary rounded border border-primary">
                                <img style="height: 350px;" src="./Images/sofa-imgs/nightstand3.webp" class="img-fluid rounded-top w-100 " alt="">
                                <div class="px-4 rounded-bottom">
                                    <div class="service-content bg-secondary text-center p-4 rounded">
                                        <h5 class="text-white"> </h5>
                                         <!-- <h3 class="mb-0">Save Up To 25% off</h3>  -->
                                    </div>
                                    <h6>July Night Stand<br><b>Rs. 96,082.50</b>    <del>Rs. 90,850.00</del>
                                    </h6>
                                </div>
...
<!-- js -->
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="nightstand-details.html">
                            <div class="service-item bg-primary rounded border border-primary ">
                                <img style="height: 350px;" src="Images/sofa-imgs/nightstand4.webp" class="img-fluid rounded-top w-100" alt="">
                                <div class="px-4 rounded-bottom">
                                    <div class="service-content bg-secondary text-center p-4 rounded">
                                        <h5 class="text-white"> </h5>
                                        <!-- <h3 class="mb-0">Save Up To 25% off</h3> -->
                                    </div>
                                    <h6>California Night Stand <br><b>Rs. 80,373.50</b>
                                    </h6>
                                </div>
                            </div>
                        </a>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="nightstand-details.html">
                            <div class="service-item bg-primary rounded border border-primary">
                                <img style="height: 350px;" src="Images/sofa-imgs/nightstand5.webp" class="img-fluid rounded-top w-100" alt="">
                                <div class="px-4 rounded-bottom">
                                    <div class="service-content bg-secondary text-center p-4 rounded">
                                        <h5 class="text-white"> </h5>
                                        <!-- <h3 class="mb-0">Save Up To 23% off</h3> -->
                                    </div>
                                    <h6>Adelaide Three Drawer Night Stand<br> <b>Rs. 5,773.00</b></h6>
                                </div>
                        ...
                        <a href="nightstand-details.html">
                            <div class="service-item bg-primary rounded border border-primary">
                                ...
                                <div class="px-4 rounded-bottom">
                                    ...
                                    <h6>Adelaide Night Stand<br> <b>Rs. 96,448.00</b> </h6>
