                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-lg-5">
                            <div class="d-flex p-4 rounded mb-4 bg-white">
                                ...
                                <div>
                                    <h4>Address</h4>
                                    <p class="mb-2">WARD NO. 03, THUKRIYASAR, TEH 
                                        DUNGARGARH
                            ...
                            <div class="d-flex p-4 rounded mb-4 bg-white">
                                ...
                                <div>
                                    <h4>Mail Us</h4>
                                    <p class="mb-2"><a href="mailto:dakshiyanihandicraft@gmail.com">dakshiyanihandicraft@gmail.com</a></p>
                                </div>
                            </div>
                            <div class="d-flex p-4 rounded bg-white">
                                ...
                                <div>
                                    <h4>Telephone</h4>
                                    <p class="mb-2"><a href="tel:+918802621101">+918802621101</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
