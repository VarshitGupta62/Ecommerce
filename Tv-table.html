            ...
            <div class="container py-5">
                <div class="row g-4 justify-content-center">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="Table-details.html">
                            <div class="service-item bg-primary rounded border border-primary">
                                <img style="height: 350px;" src="Images/sofa-imgs/Side-table1.webp" class="img-fluid rounded-top w-100 hover1" alt="">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="Table-details.html">
                            <div class="service-item bg-primary rounded border border-primary">
                                <img style="height: 350px;" src="Images/sofa-imgs/Side-table2.webp" class="img-fluid rounded-top w-100" alt="">
                                <div class="px-4 rounded-bottom">
                                    <div class="service-content bg-secondary text-center p-4 rounded">
                                        <h5 class="text-white"> </h5>
                                        <h3 class="mb-0">Save Up To 51% off</h3>
                                    </div>
                                    <h6>Cali Low Night Stand<br>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="Table-details.html">
                            <div class="service-item bg-primary rounded border border-primary">
                                <img style="height: 350px;" src="Images/sofa-imgs/side-table3.webp" class="img-fluid rounded-top w-100" alt="">
                                <div class="px-4 rounded-bottom">
                                    <div class="service-content bg-secondary text-center p-4 rounded">
                                        <h5 class="text-white"> </h5>
                                         <h3 class="mb-0">Save Up To 25% off</h3> 
                                    </div>
                                    <h6>Hector Table - Side Table in Wood <br>
                                        <b>Rs. 11,747.25 </b>    
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="Table-details.html">
                            <div class="service-item bg-primary rounded border border-primary">
                                <img style="height: 350px;" src="Images/sofa-imgs/side-table4.webp" class="img-fluid rounded-top w-100" alt="">
                                <div class="px-4 rounded-bottom">
                                    <div class="service-content bg-secondary text-center p-4 rounded">
                                        <h5 class="text-white"> </h5>
                                        <h3 class="mb-0">Save Up To 38% off</h3>
                                    </div>
                                    <h6>Bay Night Stand <br> <b>Rs. 13,800.00</b> <del>Rs. 20,125.00</del></h6>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="Table-details.html">
                            <div class="service-item bg-primary rounded border border-primary">
                                <img style="height: 350px;" src="Images/sofa-imgs/side-table5.webp" class="img-fluid rounded-top w-100" alt="">
                                <div class="px-4 rounded-bottom">
                                    <div class="service-content bg-secondary text-center p-4 rounded">
                                        <h5 class="text-white"> </h5>
                                        <h3 class="mb-0">Save Up To 23% off</h3>
                                    </div>
                                    <h6>California Night Stand <br> <b>Rs. 28,175.00</b> <del>Rs. 33,350.00</del></h6>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="Table-details.html">
                            <div class="service-item bg-primary rounded border border-primary">
                                <img style="height: 350px;" src="Images/sofa-imgs/side-table6.webp" class="img-fluid rounded-top w-100" alt="">
                                <div class="px-4 rounded-bottom">
                                    <div class="service-content bg-secondary text-center p-4 rounded">
                                        <h5 class="text-white"> </h5>
                                        <h3 class="mb-0">9% off</h3>
                                    </div>
                                    <h6>Athena Table - Side Table in Wood <br> <b>Rs. 11,747.25 </b> <del>Rs. 19,550.00</del></h6>
