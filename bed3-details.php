...
?>
    ...
    <div class="product-section">
        <div class="image-gallery">
            <img src="./Images/sofa-imgs/bed3.1.webp" alt="Product Image" class="main-image" id="mainImage">
            <div class="thumbnail-container">
                <img src="./Images/sofa-imgs/bed3.2.webp" alt="" class="thumbnail" onclick="changeImage(this)">
                <img src="./Images/sofa-imgs/bed3.3.webp" alt="" class="thumbnail" onclick="changeImage(this)">
                <img src="./Images/sofa-imgs/bed3.4.webp" alt="" class="thumbnail" onclick="changeImage(this)">
                <img src="./Images/sofa-imgs/bed3.5.webp" alt="" class="thumbnail" onclick="changeImage(this)">
                <!-- <img src="./Images/sofa-imgs/bed3.webp" alt="" class="thumbnail" onclick="changeImage(this)"> -->
               

            </div>
        </div>
        <div class="product-details">
            <h1 class="product-title">Svalbard Upholstered Hydraulic Storage Bed</h1>
            <p class="product-price">Rs. 96,485.00 <span style="text-decoration: line-through; color: #999;">Rs 87,299</span></p>
            <p class="product-description">Exceptionally opulent, fashionable bed with an upholstered wingback design. A pleasure to look at and something to be proud of.</p>
            ...
            <div class="button-container">
                <button
                onclick="addToCart('Svalbard Upholstered Hydraulic Storage Bed', 'Rs. 96,485.00', './Images/sofa-imgs/bed3.1.webp')"
