...
<div class="container-fluid py-5">
  <div class="container py-5">
    <div class="text-center mx-auto mb-5" style="max-width: 700px; margin-top: 180px;">
      <h1 class="display-4">Best Products</h1>
    </div>

    <!-- Two synchronized scrollable rows -->
    <div class="product-scroll-container">
      ...
      <div class="product-row row-1 d-flex overflow-auto">
        ...
        <div class="product-card text-center mx-2">
          <a href="coffe-table.html">
            <img src="wood-img/icon12.jpg" class="product-img rounded-circle" alt="Table Lamps">
            <p class="product-title">Table Lamps</p>
          </a>
        </div>
        <div class="product-card text-center mx-2">
          <a href="sofa.html">
            <img src="wood-img/icon4.jpg" class="product-img rounded-circle" alt="Sofa Cum Bed">
            <p class="product-title">Sofa Cum Bed</p>
          </a>
        </div>
      ...
      <div class="product-row row-2 d-flex overflow-auto mt-4">
        ...
        <div class="product-card text-center mx-2">
          <a href="Tv-table.html">
            <img src="wood-img/icon51.jpg" class="product-img rounded-circle" alt="Table Sets">
            <p class="product-title">Table Sets</p>
          </a>
        </div>
        <div class="product-card text-center mx-2">
          <a href="coffe-table.html">
            <img src="wood-img/icon7.jpg" class="product-img rounded-circle" alt="Book Shelves">
            <p class="product-title">Book Shelves</p>
          </a>
        </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="#">
                            <div class="service-item bg-secondary rounded border border-secondary">
                                <img  src="wood-img/sofa1.avif" class="img-fluid rounded-top  w-100" alt="">
                                <div class="px-4 rounded-bottom">
                                    <div class="service-content bg-primary text-center  rounded">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="#">
                            <div class="service-item bg-dark rounded border border-dark">
                                <img  src="wood-img/sofa2.avif" class="img-fluid rounded-top w-100" alt="">
                                <div class="px-4 rounded-bottom">
                                    <div class="service-content bg-danger text-center  rounded">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="#">
                            <div class="service-item bg-primary rounded border border-primary">
                                <img  src="wood-img/sofa1.jpg" class="img-fluid rounded-top w-100" alt="">
                                <div class="px-4 rounded-bottom">
