...
<!-- Navbar End -->
    ...
    <div class="product-section">
        <div class="image-gallery">
            <img src="./Images/sofa-imgs/Tv-table1.webp" alt="Product Image" class="main-image" id="mainImage">
            <div class="thumbnail-container">
                <img src="./Images/sofa-imgs/Tv-table2.webp" alt="" class="thumbnail" onclick="changeImage(this)">
                <img src="./Images/sofa-imgs/Tv-table3.webp" alt="" class="thumbnail" onclick="changeImage(this)">
                <img src="./Images/sofa-imgs/tv-table4.webp" alt="" class="thumbnail" onclick="changeImage(this)">
            </div>
        </div>
        <div class="product-details">
            ...
            <div class="button-container">
                <button
                                            onclick="addToCart('./Images/sofa-imgs/Tv-table1.webp', 'Rs. 17499', 'wood-img/bed1.jpg')"
