...
<!-- Navbar End -->
    ...
    <div class="product-section">
        <div class="image-gallery">
            <img src="./Images/sofa-imgs/1...sofas-accent-chairs-rose-gold-boucle-amor-2-seater-sofa.jpg" alt="Product Image" class="main-image" id="mainImage">
            <div class="thumbnail-container">
                <img src="./Images/sofa-imgs/2...sofas-accent-chairs-rose-gold-boucle-amor-2-seater-sofa.webp" alt="" class="thumbnail" onclick="changeImage(this)">
                <img src="./Images/sofa-imgs/3...sofas-accent-chairs-rose-gold-boucle-amor-2-seater-sofa-3.webp" alt="" class="thumbnail" onclick="changeImage(this)">
                <img src="./Images/sofa-imgs/4....sofas-accent-chairs-rose-gold-boucle-amor-2-seater-sofa-4.webp" alt="" class="thumbnail" onclick="changeImage(this)">
                <img src="./Images/sofa-imgs/5...sofas-accent-chairs-rose-gold-boucle-amor-2-seater-sofa-5.webp" alt="" class="thumbnail" onclick="changeImage(this)">
               

            </div>
        </div>
        <div class="product-details">
            <h1 class="product-title">Althea Upholstered Hydraulic Storage Bed</h1>
            <p class="product-price">Rs. 51750 <span style="text-decoration: line-through; color: #999;">Rs 87,299</span></p>
            <p class="product-description">Introducing the "Althea Upholstered Hydraulic Storage Bed", blending a captivating Bulky design with practicality. Wrapped in luxurious Tangerine Colored plush velvet fabric, it exudes warmth and style. The soft foaming ensures a restful night's sleep, while the hydraulic storage space provides ample room for bedding and essentials, maximizing bedroom organization. With its playful yet sophisticated aesthetic, the Althea Bed adds both comfort and functionality to any bedroom.</p>
            <div class="product-overview">
                <h3></h3>
               <ul>
                <li>Captivating Bulky design with playful Tangerine Colored plush velvet fabric
                    
                    
                    <li>Soft foaming for enhanced comfort</li>
                    <li>Hydraulic storage space for bedding and essentials</li></li>
               </ul>
            </div>

            <div class="button-container">
                                           <button
                                            onclick="addToCart('Amour 2 seater Sofa', 'Rs. 51750', './Images/sofa-imgs/1...sofas-accent-chairs-rose-gold-boucle-amor-2-seater-sofa.jpg')"
                ...
                <a href="my-cart.html"><button class="button buy-now">Buy Now</button></a>
            </div>
        </div>
    </div>
