            ...
            <div class="container py-5">
                <div class="row g-4 justify-content-center">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="Table-details.html">
                            <div class="service-item bg-primary rounded border border-primary">
                                <img style="height: 350px;" src="Images/sofa-imgs/Tv-table1.webp" class="img-fluid rounded-top w-100 hover1" alt="">

                                <div class="px-4 rounded-bottom">
                                    <div class="service-content bg-secondary text-center p-4 rounded">
                                        <h5 class="text-white"> </h5>
                                        <h3 class="mb-0">Save Up To 28% off</h3>
                                    </div>
                                    <h6>London TV Unit Console<br>
                                       <b>Rs. 37,058.75 </b>   <Del>Rs. 51,750.00</Del>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="Table-details.html">
                            <div class="service-item bg-primary rounded border border-primary">
                                <img style="height: 350px;" src="Images/sofa-imgs/Tv-table2.webp" class="img-fluid rounded-top w-100" alt="">
                                <div class="px-4 rounded-bottom">
                                    <div class="service-content bg-secondary text-center p-4 rounded">
                                        <h5 class="text-white"> </h5>
                                        <h3 class="mb-0">Save Up To 24% off</h3>
                                    </div>
                                    <h6>Misa TV Table Console<br>
                                        <b>Rs. 42,205.00</b>   <Del>Rs. 55,773.85</Del>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="Table-details.html">
                            <div class="service-item bg-primary rounded border border-primary">
                                <img style="height: 350px;" src="Images/sofa-imgs/Tv-table3.webp" class="img-fluid rounded-top w-100" alt="">
                                <div class="px-4 rounded-bottom">
                                    <div class="service-content bg-secondary text-center p-4 rounded">
                                        <h5 class="text-white"> </h5>
                                         <h3 class="mb-0">Save Up To 11% off</h3> 
                                    </div>
                                    <h6>Long Beach TV Table Console <br>
                                        <b>Rs. 55,200.00</b>    
                                        <del>Rs. 62,673.85</del>
                                       </h6>
                                </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="Table-details.html">
                            <div class="service-item bg-primary rounded border border-primary">
                                <img style="height: 350px;" src="Images/sofa-imgs/tv-table4.webp" class="img-fluid rounded-top w-100" alt="">
                                <div class="px-4 rounded-bottom">
                                    <div class="service-content bg-secondary text-center p-4 rounded">
                                        <h5 class="text-white"> </h5>
                                        <h3 class="mb-0">Save Up To 28% off</h3>
                                    </div>
                                    <h6>London TV Unit Console<br><b>Rs. 37,058.75</b>    <del>Rs. 51,750.00</del>
                                    </h6>
                                </div>
                            </div>
                        </a>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="Table-details.html">
                            <div class="service-item bg-primary rounded border border-primary">
                                <img style="height: 350px;" src="Images/sofa-imgs/Tv-table5.webp" class="img-fluid rounded-top w-100" alt="">
                                <div class="px-4 rounded-bottom">
                                    <div class="service-content bg-secondary text-center p-4 rounded">
                                        <h5 class="text-white"> </h5>
                                        <h3 class="mb-0">Save Up To 23% off</h3>
                                    </div>
                                    <h6>Summer Large Coffee Table <br> <b>Rs. 13,490.65</b> <del> Rs. 17,250.00</del></h6>
                                </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="Table-details.html">
                            <div class="service-item bg-primary rounded border border-primary">
                                <img style="height: 350px;" src="Images/sofa-imgs/Tv-table6.webp" class="img-fluid rounded-top w-100" alt="">
                                <div class="px-4 rounded-bottom">
                                    <div class="service-content bg-secondary text-center p-4 rounded">
                                        <h5 class="text-white"> </h5>
                                        <h3 class="mb-0">9% off</h3>
                                    </div>
                                    <h6>California TV Table Console <br> <b>Rs. 30,245.00</b> <del>Rs. 33,350.00</del></h6>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="Table-details.html">
                            <div class="service-item bg-primary rounded border border-primary">
                                <img style="height: 350px;" src="Images/sofa-imgs/coffe-table-summer2.webp" class="img-fluid rounded-top w-100" alt="">
                                <div class="px-4 rounded-bottom">
                                    <div class="service-content bg-secondary text-center p-4 rounded">
                                        <h5 class="text-white"> </h5>
                                        <h3 class="mb-0">Save Up To 21% off</h3>
                                    </div>
                                    <h6>Adelaide Extra Large TV Table Console <br> <b>Rs. 13,490.65</b> <del>Rs. 17,250.20</del></h6>
                                </div>
                            </div>
                        </a>
                    </div>
                ...
                <div class="row g-4">
                    <div class="col-lg-6 col-xl-4">
                        <div class="p-2 rounded bg-light">
                            <div class="row align-items-center">
                                <div class="col-6">
                                    <img src="Images/sofa-imgs/coffe-table2.webp" class="img-fluid rounded-circle w-100" alt="">
                                </div>
                                 <div class="col-6"> 
                                     <a href="#" class="h5">Coffee Table</a>
                    ...
                    <div class="col-lg-6 col-xl-4">
                        <div class="p-4 rounded bg-light">
                            <div class="row align-items-center">
                                <div class="col-6">
                                    <img src="Images/sofa-imgs/coffe-table-summer6.webp" class="img-fluid rounded-circle w-100" alt="">
                                </div>
                                <div class="col-6">
                                    <a href="#" class="h5">Coffee Table</a>
                                    <div class="d-flex my-3">
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        <div class="text-center" style="border: 2px solid rgb(0, 0, 0); border-radius: 10px;">
                            <img src="Images/sofa-imgs/coffe-table-summer5.webp" class="img-fluid rounded" style="width: 100%" alt="">
                            <div class="py-4">
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        <div class="text-center" style="border: 2px solid rgb(0, 0, 0); border-radius: 10px;">
                            <img src="Images/sofa-imgs/coffe-table-summer2.webp" class="img-fluid rounded" style="width: 100%; height: 20% !important; " alt="">
                            <div class="py-4">
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        <div class="text-center" style="border: 2px solid rgb(0, 0, 0); border-radius: 10px;">
                            <img src="Images/sofa-imgs/coffe-table-summer3.webp" class="img-fluid rounded" alt="">
                            <div class="py-4">
                                <a href="#" class="h5">Coffe table</a>
                                <div class="d-flex my-3 justify-content-center">
                                    <i class="fas fa-star text-primary"></i>
                                    <i class="fas fa-star text-primary"></i>
                                    <i class="fas fa-star text-primary"></i>
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        <div class="text-center" style="border: 2px solid rgb(0, 0, 0); border-radius: 10px;">
                            <img src="./Images/sofa-imgs/coffe-table2.3.webp" style="width: 100%;" class="img-fluid rounded" alt="">
                            <div class="py-2">
                                <a href="#" class="h5">Coffee Table</a>
